...
public class CliRunnerImpl implements CliRunner {
  ...
  @Override
  public boolean run(String sourceFile, String clazzName, String basePackage,
                     App.Language language, boolean showGuiTree) {
    ...
    try {
      ...
      if (showGuiTree) {
        ...
        frame.setVisible(true);
              ...
              | SourceGenerationException | IntermediateRepresentationException exception) {
